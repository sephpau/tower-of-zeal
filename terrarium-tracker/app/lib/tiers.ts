...
// Luna's Landing is the 3×3 land region at rows −1..1, cols −22..−20 (9 lands,
// decoded from the Axie Land token-id coordinate encoding). Owners are resolved
// live via ownerOf, so the full set is on-chain and self-updating — independent
// of any hand-provided wallet list.
const LUNAS_LANDING_TOKEN_IDS = [
  // row -1
  "115792089237316195423570985008687907853269984665640564039070202382365229055999", // -1,-22
  "115792089237316195423570985008687907853269984665640564039088649126438938607615", // -1,-21
  "115792089237316195423570985008687907853269984665640564039107095870512648159231", // -1,-20
  // row 0
  "115792089237316195417293883273301227089774477609353836086431221545332962754559", // 0,-22
  "115792089237316195417293883273301227089774477609353836086449668289406672306175", // 0,-21
  "115792089237316195417293883273301227089774477609353836086468115033480381857791", // 0,-20
  // row 1
  "115792089237316195417293883273301227090114759976274774549894596152764730966015", // 1,-22
  "115792089237316195417293883273301227090114759976274774549913042896838440517631", // 1,-21
  "115792089237316195417293883273301227090114759976274774549931489640912150069247", // 1,-20
];
