...
public enum PowerupType { WeaponUp, Rapid, Homing, ShieldCell }
...
public class Powerup : MonoBehaviour
{
    ...
    static readonly Color[] Colors = {
        ...
        new Color(1f, 0.4f, 0.85f),   // Homing    — pink
    ...
    public static void TryDrop(Vector3 pos, float chance)
    {
        ...
        PowerupType t =
            roll < 0.3f ? PowerupType.WeaponUp :
            roll < 0.55f ? PowerupType.Rapid :
            roll < 0.75f ? PowerupType.Homing : PowerupType.ShieldCell;
