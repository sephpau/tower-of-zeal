...
export const SHOP_CATALOG: ShopItemDef[] = [
  ...
  { id: "buff_battle_cry",       name: "Battle Cry",        description: "Buy once to receive 3 charges. Slot one before any battle to start that floor with all player ATB gauges full.", category: "buff", priceLabel: "Price soon · $crypto" },
  ...
  { id: "buff_last_stand",       name: "Last Stand",        description: "When only one of your units remains alive on the battlefield, that unit's damage is doubled. Comeback insurance.", category: "buff", priceLabel: "Price soon · $crypto" },
];
